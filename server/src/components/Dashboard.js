...
import { Navbar, Switch } from '@material-tailwind/react';
...
export default function Dashboard() {
  ...
  return (
    <div>
      ...
      </button><aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
