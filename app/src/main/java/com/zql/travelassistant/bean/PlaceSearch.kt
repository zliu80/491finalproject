...
data class CurrentOpenningHours(var open_now: Boolean, var periods: List<Periods>, var weekday_text:List<String>)
data class Periods(var close:Date, var open:Date)
data class Date(var date:String, var day:Int, var time:String)

data class Reviews(var author_name:String, var author_url:String,
                   var language:String,
