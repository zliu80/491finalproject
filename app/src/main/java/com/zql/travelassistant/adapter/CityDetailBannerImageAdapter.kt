 ...
 */
class CityDetailBannerImageAdapter(var data: List<Attraction>) :
    BannerAdapter<Attraction?, CityDetailBannerImageAdapter.BannerViewHolder?>(data) {
    ...
    override fun onBindView(
        ...
        Picasso.get().load(TSApplication.getAttractionAbsoluteImageUrl(data!!))
