...
class GoogleMapsActivity : AppCompatActivity() , OnMapReadyCallback,
    ...
    // TAG
    private var TAG = GoogleMapsActivity::class.java.name
    // Map moving reason
...
//        }
        ...
        var adapter = PlacesRecyclearViewAdapter(mContext, list)
    ...
    private fun loadPlaces(latitude:Double, longtitude:Double){
        var name =query+" in main street"
        RetrofitClient.api.searchPlaces((latitude.toString()+","+longtitude.toString()),name, query!!, TSApplication.GOOGLE_MAPS_API_KEY)
