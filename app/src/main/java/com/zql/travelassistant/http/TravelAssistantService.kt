...
interface TravelAssistantService {
    ...
    @Headers("X-RapidAPI-Key:6cc1aa3ed3msh2cd79da32284ec1p1c8979jsna8f06a559504",
    ...
    fun searchPlace(@Query("fields") field: String, @Query("input") input:String, @Query("inputtype") inputtype:String, @Query("key") key:String):Call<PlaceSearch>

    @GET("https://maps.googleapis.com/maps/api/place/details/json")
    fun placeDetail(@Query("fields") field: String, @Query("place_id") place_id:String, @Query("key") key:String):Call<PlaceDetail>

    @GET("https://maps.googleapis.com/maps/api/place/textsearch/json")
    fun searchPlaces(@Query("location") location:String, @Query("query") name:String, @Query("type") type:String, @Query("key") key:String):Call<Place>
}